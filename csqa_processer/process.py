...
if __name__ == "__main__":
    ##get_question_by_type('./CSQA_v9/train', './out_dir/qtype_train')
    ...
    ##extract_contextual('./CSQA_v9/train', './out_dir/context')
    ...
    process('./out_dir/context', './items_wikidata_n.json', './out_dir/processed')
