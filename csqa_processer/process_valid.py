...
if __name__ == "__main__":
    get_question_by_type('./CSQA_v9/valid', './out_dir/qtype_valid')
    ...
    extract_contextual('./CSQA_v9/valid', './out_dir/context_valid')
    ...
    process('./out_dir/context_valid', './items_wikidata_n.json', './out_dir/processed_valid')
