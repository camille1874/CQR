...
import beam_search
#import beam_search_cons as beam_search
import data
import json
import pyrouge
import util
...
class BeamSearchDecoder(object):
  ...
  def decode(self):
    ...
    while True:
      ...
      if batch is None or end_decode: # finished decoding dataset in single_pass mode
      ...
      #best_hyp = beam_search.run_beam_search(self._sess, self._model, self._vocab, batch, original_article)
