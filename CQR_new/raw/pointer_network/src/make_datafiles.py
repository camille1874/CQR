...
def write_qa_to_bin(train_file, out_file, vocab_file, makevocab=False):
  ...
  with open(out_file, 'wb') as writer:
    for i in range(len(lines)):
      ...
      try:
        #question,answer,_ = lines[i].strip().split(" || ")
        question,answer = lines[i].strip().split(" || ")
...
if __name__ == '__main__':
  write_qa_to_bin("../data/all_test_noaction.txt",
                  "../data/test.bin",
                  "../data/vocab",
                  False)
  #write_qa_to_bin("../data/train_0.001_noaction.txt",
  #                "../data/train.bin",
  #                "../data/vocab",
  #                True)
  #write_qa_to_bin("../data/train_all_noaction.txt",
  #                "../data/train.bin",
  #                "../data/vocab",
  #                True)
